<?php if ( have_comments() ) : ?>
	...
	<ol class="comment-list">
		<?php
			 ...
			 * to use hybrid_comment() to format the comments.
			 * If you want to overload this in a child theme then you can
			 * define hybrid_comment() and that will be used instead.
			 * See hybrid_comment() in lib/inc/template-tags.php for more.
			 */
			$args = array(
				'walker'            => null,
				'max_depth'         => '',
