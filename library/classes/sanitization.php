...
class ExMachina_Settings_Sanitizer {
   ...
   *
   * @uses ExMachina_Settings_Sanitizer::one_zero()                 Returns a 1 or 0.
   * @uses ExMachina_Settings_Sanitizer::absint()                   Returns a positive integer.
   * @uses ExMachina_Settings_Sanitizer::url()                      Returns a safe URL value.
   * @uses ExMachina_Settings_Sanitizer::no_html()                  Removes all HTML tags.
   * @uses ExMachina_Settings_Sanitizer::safe_html()                Removes all unsafe HTML tags.
   * @uses ExMachina_Settings_Sanitizer::requires_unfiltered_html() Returns unfiltered HTML (if allowed).
   *
   * @since 1.0.0
   *
