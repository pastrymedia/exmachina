...
abstract class ExMachina_Admin {
   ...
   *
   * @uses ExMachina_Admin::maybe_add_main_menu()     Possibly create a new top level admin menu.
   * @uses ExMachina_Admin::maybe_add_first_submenu() Possibly create the first submenu item.
   * @uses ExMachina_Admin::maybe_add_submenu()       Possibly create a submenu item.
   * @uses ExMachina_Admin::maybe_add_theme_submenu() Possibly create a theme submenu item.
   * @uses ExMachina_Admin::register_settings()       Register the database settings for storage.
   * @uses ExMachina_Admin::notices()                 Display notices on the save or reset of settings.
   * @uses ExMachina_Admin::settings_init()           Initialize the settings page.
   * @uses ExMachina_Admin::save()                    Save method.
   *
   * @since 1.0.0
   * @access public
   *
   ...
   * @link http://codex.wordpress.org/Function_Reference/wp_parse_args
   *
   * @uses ExMachina_Admin::settings_page() Settings page callback function.
   *
   * @since 1.0.0
   * @access public
   *
   ...
   * @link http://codex.wordpress.org/Function_Reference/wp_parse_args
   *
   * @uses ExMachina_Admin::settings_page() Admin page callback method.
   *
   * @since 1.0.0
   * @access public
   *
...
/*-------------------------------------------------------------------------*/
/* Begin class ExMachina_Admin_Basic */
/*-------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------*/
/* Begin class ExMachina_Admin_Form */
/*-------------------------------------------------------------------------*/
...
abstract class ExMachina_Admin_Form extends ExMachina_Admin {
   ...
   *
   * @uses ExMachina_Admin_Form::settings_form() Generates the settings page output.
   *
   * @since 1.0.0
   * @access public
   *
   ...
   *
   * @uses ExMachina_Admin::get_field_name() Gets the field name from the settings field.
   *
...
/*-------------------------------------------------------------------------*/
/* Begin class ExMachina_Admin_Metaboxes */
/*-------------------------------------------------------------------------*/
...
abstract class ExMachina_Admin_Metaboxes extends ExMachina_Admin {
   ...
   * @todo maybe remove settings_page_add_metaboxes()
   *
   * @since 1.0.0
   * @access public
   *
