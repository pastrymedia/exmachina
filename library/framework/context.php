 ...
 * @link http://codex.wordpress.org/Function_Reference/get_page_template
...
function exmachina_get_context() {
  ...
  elseif ( is_singular() ) {
    ...
    if ( is_page_template() ) {
      ...
      if ( $page_template && ! in_array( $page_template, $skip ) ) {
        ...
        $exmachina->context[] = $page_template;

      } // end if ($page_template && !in_array($page_template, $to_skip))

    } // end if (is_page_template())

    $exmachina->context[] = "singular-{$object->post_type}-{$object_id}";

  } // end elseif (is_singular())
  ...
  elseif ( is_archive() ) {
    ...
    } // end if (is_tax() || is_category() || is_tag())
...
function exmachina_body_attributes() {
  ...
  /* Set the body class attributes. */
  $attributes['class'] = join( ' ', exmachina_get_body_class() );

  /* Apply the atomic filters. */
 ...
 * @link http://codex.wordpress.org/Function_Reference/sanitize_html_class
 * @link http://codex.wordpress.org/Function_Reference/get_the_author_meta
 * @link http://codex.wordpress.org/Function_Reference/post_password_required
 * @link http://codex.wordpress.org/Function_Reference/post_type_supports
 * @link http://codex.wordpress.org/Function_Reference/has_excerpt
 * @link http://codex.wordpress.org/Function_Reference/current_theme_supports
 * @link http://codex.wordpress.org/Function_Reference/get_post_format
 * @link http://codex.wordpress.org/Function_Reference/is_wp_error
 ...
 *
 * @link http://codex.wordpress.org/Function_Reference/get_comment_class
