...
/**
 * Extension Textdomains
 *
 * Creates an array of available extension textdomains. This function does not
 * check if the extensions are in use, it merely provides an array of textdomain
 * strings. Can be filtered via 'exmachina_extensions_textdomains' to add more
 * extension textdomains.
 *
 * @since 2.3.0
 * @access public
 *
 * @return array Array of extension textdomains.
 */
function exmachina_extensions_textdomains() {

  /* Set up the default extension textdomain strings. */
  ...
  return apply_filters( 'exmachina_extensions_textdomains', $extensions );

} // end function exmachina_extensions_textdomains()
...
function exmachina_extensions_gettext( $translated, $text, $domain ) {
  ...
  $extensions = exmachina_extensions_textdomains();
