 ...
 */
function exmachina_category_transient_flusher() {
	// Like, beat it. Dig?
	delete_transient( 'all_the_cool_cats' );
}
add_action( 'edit_category', 'exmachina_category_transient_flusher' );
add_action( 'save_post',     'exmachina_category_transient_flusher' );