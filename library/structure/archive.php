...
/* Filters the image/gallery post format archive galleries. */
  add_filter( hybrid_get_prefix() . '_post_format_archive_gallery_columns', 'hybrid_archive_gallery_columns' );
/**
 ...
 * @return int $columns
 */
function hybrid_archive_gallery_columns( $columns ) {
