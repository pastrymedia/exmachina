 ...
 *
 * The Pages widget replaces the default WordPress Pages widget. This version
 * gives total control over the output to the user by allowing the input of all
 * the arguments typically seen in the wp_list_pages() function.
 *
 * @package     ExMachina
 * @subpackage  Widgets
...
} // end class ExMachina_Widget_Pages