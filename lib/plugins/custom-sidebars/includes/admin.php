 ...
 * for the ExMachina Simple Sidebars plugin.
 *
 * @since 1.0.0
 */
class ExMachina_Simple_Sidebars_Admin extends ExMachina_Admin_Basic {
	 ...
	 * @since 1.0.0
	 *
	 * @uses ExMachina_Admin::create() Register the admin page
	 *
	 * @see ExMachina_Admin_Import_Export::actions() Handle creating, editing, and deleting sidebars.
	 */
	...
	public function actions() {
		...
		if ( ! exmachina_is_menu_page( 'simple-sidebars' ) )
			return;
...
add_action( 'exmachina_admin_menu', 'simplesidebars_settings_menu' );
/**
...
function simplesidebars_settings_menu() {
	...
	new ExMachina_Simple_Sidebars_Admin;
