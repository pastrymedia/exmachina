...
class ExMachina_Settings_Sanitizer {
	 ...
	 *
	 * Array can be filtered via 'exmachina_available_sanitizer_filters' to let
 ...
 *
 * Use the 'exmachina_settings_sanitizer_init' action to be notified when this function is safe to use
 *
 * @since 1.7.0
 *
 * @uses ExMachina_Settings_Sanitizer::add_filter()
 *
 * @param string $filter The filter to call (see ExMachina_Settings_Sanitizer::$available_filters for options)
