 ...
 * @since 1.4.0
 *
 * @uses exmachina_author_box() Echo the author box and its contents.
 *
 * @see exmachina_do_author_title_and_description Author title and description.
 *
 ...
 * @since 2.0.0
 *
 * @uses exmachina_has_post_type_archive_support() Check if a post type should potentially support an archive setting page.
 * @uses exmachina_get_cpt_option()                Get list of custom post types which need an archive settings page.
 *
