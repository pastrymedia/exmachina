 ...
 *
 * Default filename is minified.css, although this is filterable via exmachina_design_get_minified_stylesheet_name.
 * @author StudioPress
 * @return string
 * @since 1.0.0
 */
 ...
 *
 * Default filename is settings.css, although this is filterable via exmachina_design_get_settings_stylesheet_name.
 * @author StudioPress
 * @return string
 * @since 1.0.0
 */
 ...
 *
 * Default filename is custom-style.css, although this is filterable via exmachina_design_get_custom_stylesheet_name.
 * @author StudioPress
 * @return string
 * @since 1.0.0
 */
 ...
 * @uses exmachina_get_admin_design_mapping()
 */
...
/**
 * Attempts to create all stylesheets when the theme is activated.
 *
 * @author StudioPress
 * @since 1.0.0
 */
