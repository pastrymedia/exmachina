...
function exmachina_reset_loops() {
	...
	//* Pre-HTML5 hooks
	add_action( 'exmachina_before_post_title', 'exmachina_do_post_format_image' );
	add_action( 'exmachina_post_title', 'exmachina_do_post_title' );
	add_action( 'exmachina_post_content', 'exmachina_do_post_image' );
	add_action( 'exmachina_post_content', 'exmachina_do_post_content' );
	add_action( 'exmachina_post_content', 'exmachina_do_post_permalink' );
	add_action( 'exmachina_post_content', 'exmachina_do_post_content_nav' );
	add_action( 'exmachina_before_post_content', 'exmachina_post_info' );
	add_action( 'exmachina_after_post_content', 'exmachina_post_meta' );
	add_action( 'exmachina_after_post', 'exmachina_do_author_box_single' );
 ...
 *
 * @return null Return early if post formats are not supported, or `exmachina-post-format-images` is not supported
 */
 ...
 *
 * The `exmachina_post_title_text` filter is applied on the text of the title, while the `exmachina_post_title_output`
 ...
 *
 * The post info makes use of several shortcodes by default, and the whole output is filtered via `exmachina_post_info`
 * before echoing.
 *
 * @since 0.2.3
 *
 ...
 *
 * The applied filter is `exmachina_noposts_text`.
 *
 * @since 1.1.0
 */
 ...
 * `exmachina_post_meta` before echoing.
 *
 * @since 0.2.3
 *
 * @uses exmachina_markup() Contextual markup.
 ...
 *
 * The title is filterable via `exmachina_author_box_title`, and the gravatar size is filterable via
 * `exmachina_author_box_gravatar_size`.
 *
 * The final output is filterable via `exmachina_author_box`, which passes many variables through.
 *
 * @since 1.3.0
 *
 * @uses exmachina_html5() Check for HTML5 support.
 ...
 *
 * Applies `exmachina_prev_link_text` and `exmachina_next_link_text` filters.
 *
 * @since 0.2.2
 */
 ...
 *
 * Applies the `exmachina_prev_link_text` and `exmachina_next_link_text` filters.
 *
