...
class ExMachina_Admin_SEO_Settings extends ExMachina_Admin_Metaboxes {
	...
	function settings_page_load_metaboxes() {
		...
		add_meta_box( 'exmachina-seo-settings-doctitle', __( 'Document Title Settings', 'exmachina' ), array( $this, 'doctitle_box' ), $this->pagehook, 'normal' );
		add_meta_box( 'exmachina-seo-settings-homepage', __( 'Homepage Settings', 'exmachina' ), array( $this, 'homepage_box' ), $this->pagehook, 'normal' );
		add_meta_box( 'exmachina-seo-settings-dochead', __( 'Document Head Settings', 'exmachina' ), array( $this, 'document_head_box' ), $this->pagehook, 'normal' );
		add_meta_box( 'exmachina-seo-settings-robots', __( 'Robots Meta Settings', 'exmachina' ), array( $this, 'robots_meta_box' ), $this->pagehook, 'normal' );
		add_meta_box( 'exmachina-seo-settings-archives', __( 'Archives Settings', 'exmachina' ), array( $this, 'archives_box' ), $this->pagehook, 'normal' );
