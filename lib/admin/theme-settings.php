 ...
 * @since 1.8.0
 */
class ExMachina_Admin_Settings extends ExMachina_Admin_Metaboxes {
	 ...
	 * @since 1.8.0
	 *
	 * @uses EXMACHINA_ADMIN_IMAGES_URL     URL for admin images.
		...
		$menu_ops = apply_filters(
			...
			array(
				'main_menu' => array(
					...
					'icon_url'   => EXMACHINA_ADMIN_IMAGES_URL . '/exmachina-menu.png',
					'position'   => '58.996',
				),
