 ...
 * @since 1.8.0
 */
class ExMachina_Admin_Settings extends ExMachina_Admin_Boxes {
	...
	function metaboxes() {
		...
		if ( ! current_theme_supports( 'exmachina-custom-header' ) && ! current_theme_supports( 'custom-header' ) )
			add_meta_box( 'exmachina-theme-settings-header', __( 'Header', 'exmachina' ), array( $this, 'header_box' ), $this->pagehook, 'main' );

		if ( current_theme_supports( 'exmachina-menus' ) )
			add_meta_box( 'exmachina-theme-settings-nav', __( 'Navigation', 'exmachina' ), array( $this, 'nav_box' ), $this->pagehook, 'main' );

		if ( current_theme_supports( 'exmachina-breadcrumbs' ) )
			add_meta_box( 'exmachina-theme-settings-breadcrumb', __( 'Breadcrumbs', 'exmachina' ), array( $this, 'breadcrumb_box' ), $this->pagehook, 'main' );

		add_meta_box( 'exmachina-theme-settings-comments', __( 'Comments and Trackbacks', 'exmachina' ), array( $this, 'comments_box' ), $this->pagehook, 'main' );
		add_meta_box( 'exmachina-theme-settings-posts', __( 'Content Archives', 'exmachina' ), array( $this, 'post_archives_box' ), $this->pagehook, 'main' );
		add_meta_box( 'exmachina-theme-settings-blogpage', __( 'Blog Page Template', 'exmachina' ), array( $this, 'blogpage_box' ), $this->pagehook, 'main' );
