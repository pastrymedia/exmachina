 ...
 * @package ExMachina\Admin
 */
class ExMachina_Admin_CPT_Archive_Settings extends ExMachina_Admin_Boxes {
	...
	public function metaboxes() {
		add_meta_box( 'exmachina-cpt-archives-settings', __( 'Archive Settings', 'exmachina' ), array( $this, 'archive_box' ), $this->pagehook, 'main' );
		add_meta_box( 'exmachina-cpt-archives-seo-settings', __( 'SEO Settings', 'exmachina' ), array( $this, 'seo_box' ), $this->pagehook, 'main' );
		add_meta_box( 'exmachina-cpt-archives-layout-settings', __( 'Layout Settings', 'exmachina' ), array( $this, 'layout_box' ), $this->pagehook, 'main' );
